...
<div class="relative min-h-screen flex flex-col">
        ...
        <div class="flex-1 w-full max-w-2xl grid grid-cols-1 md:grid-cols-2 gap-8 relative">
            ...
            <div class="bg-white p-10 rounded-[3rem] shadow-[0_20px_50px_rgba(79,70,229,0.15)] border border-gray-100 relative overflow-hidden group hover:-translate-y-2 transition-all duration-500">
                <div class="relative z-10">
                    ...
                    <?php if(isset($_SESSION['error']) && (!isset($_SESSION['error_role']) || $_SESSION['error_role'] === 'student')): ?>
                         <div class="bg-rose-50 border-2 border-rose-100 p-4 rounded-[1.5rem] mb-6 animate-in zoom-in-95 duration-300 flex items-center space-x-3 shadow-sm">
                            ...
                            <p class="text-[11px] font-black text-rose-600 uppercase tracking-widest leading-tight">
                                <?= htmlspecialchars($_SESSION['error']); unset($_SESSION['error']); unset($_SESSION['error_role']); ?>
                            </p>
                        </div>
                    <?php endif; ?>
            ...
            <div class="bg-slate-900 p-10 rounded-[3rem] shadow-[0_20px_50px_rgba(30,58,95,0.4)] border border-slate-800 relative overflow-hidden group hover:-translate-y-2 transition-all duration-500">
                <div class="relative z-10 text-white">
                    ...
                    <?php if(isset($_SESSION['error']) && isset($_SESSION['error_role']) && $_SESSION['error_role'] === 'admin'): ?>
    ...
    <footer class="container mx-auto px-8 py-14 flex flex-col md:flex-row justify-between items-center gap-8 border-t border-slate-100 mt-20">
        <p class="text-[10px] font-black text-slate-600 uppercase tracking-widest">Â© 2026 EduQuest Intelligence Corp. All rights reserved.</p>
