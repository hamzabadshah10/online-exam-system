...
if (!isset($_SESSION['user_id']) || $_SESSION['role'] !== 'student') { header('Location: ../php/index.php'); exit; }
...
<div class="flex justify-between items-center px-8 py-5 bg-[#1e3a5f] border-b-2 border-white z-20 flex-shrink-0 shadow-2xl">
